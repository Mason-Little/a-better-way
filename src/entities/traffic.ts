...
export const SlowdownSchema = z.object({
...
export const AvoidZoneSchema = z.object({
...
export const AvoidZoneOptionsSchema = z.object({
  radiusMeters: z.number().optional().describe('Radius around the point in meters'),
  slowdownThreshold: z.number().optional().describe('Only include slowdowns worse than this (0-1)'),
